...
from Code.I3D.aslcitizen_dataset import ASLCitizen as Dataset
import cv2
...
save_model = r"C:\Users\ADITYA\OneDrive\Desktop\IIT\saved_weights_jan_1a"
dataset_name = "ASL_Citizen_" #name of dataset
...
if __name__ == '__main__':
    ...
    test_loader = torch.utils.data.DataLoader(test_ds, batch_size=4, shuffle=True, num_workers=2, pin_memory=True)
        ...
        for phase in ['train', 'test']:
            ...
            if phase == 'test':
                ...
                if val_score > best_val_score or epoch % 2 == 0:
                    ...
                    model_name = os.path.join(save_model, f"jan_1a_epoch{epoch}_val{val_score:.3f}.pt")
